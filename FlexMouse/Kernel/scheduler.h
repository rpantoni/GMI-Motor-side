...
#define STRUCT_MEM_ID_MODULE_USART2_BUFFER 0
#define STRUCT_MEM_ID_MODULE_FLASH_BUFFER 1
#define STRUCT_MEM_ID_MODULE_MC_STATEMACHINE_BUFFER 2
#define STRUCT_MEM_ID_MODULE_APP_BUFFER   3                       //Pam: Add the structured-memory instance ID
#define STRUCT_MEM_ID_MODULE_SHORT_CMD    4
#define STRUCT_MEM_ID_MODULE_REPLY_CMD    5
#define STRUCT_MEM_ID_MODULE_FLASH_UPDATE_CMD    6
...
#define STRUCT_MEM_SETUP_TABLE_COUNT (MODULE_USART2_TOTAL_STRUCT+ MODULE_FLASH_TOTAL_STRUCT + MODULE_MC_STATEMACHINE_TOTAL_STRUCT + MODULE_SHORT_CMD_TOTAL_STRUCT + MODULE_REPLY_CMD_TOTAL_STRUCT + MODULE_APP_TOTAL_STRUCT + MODULE_AUTOACK_TOTAL_STRUCT + \
...
#define SEQ_MEM_ID_MODULE_USART2_RXG1_2         1
#define SEQ_MEM_ID_MODULE_USART2_RXG3           2
#define SEQ_MEM_ID_MODULE_USART2_RXG4L          3
#define SEQ_MEM_ID_MODULE_USART2_RXG4U          4
#define SEQ_MEM_ID_MODULE_USART2_TX             5
#define TOTAL_NUM_OF_SEQ_MEM_INSTANCES 6 // should always be the last member of this enum
//};
...
#define SEQ_MEM_SETUP_TABLE_COUNT (MODULE_GPIO_TOTAL_SEQ + MODULE_USART2_TOTAL_SEQ + MODULE_FLASH_REGISTER_CMD_TOTAL_SEQ ) // Used as a double check-only
